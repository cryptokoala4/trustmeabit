...
app.config(['$stateProvider', '$urlRouterProvider', '$authProvider', function($stateProvider,  $urlRouterProvider, $authProvider){
  ...
  $stateProvider
    .state('home', {
      url: '/',
      templateUrl: "/assets/pages/index-f3c879730203d63793caff06cbf2352a5dbd5fd5d194db99c877284676720e1d.html"
    })
    .state('dashboard', {
      url: '/dashboard',
...
app.directive('mainFooter', function (){
  return {
    restrict: 'E',
    templateUrl: "/assets/partials/footer-201f1bc465f89dfed653b6e1e241158bfcb76cb0aeb1e7489269f37db111342e.html"
  }
})
;
app.directive('mainNavBar', function (){
  return {
    restrict: 'E',
    templateUrl: "/assets/partials/navbar-30bf96572758b108962d2dd3abdfa4cf028b8686fbb884952fe95561d5c74dd7.html",
